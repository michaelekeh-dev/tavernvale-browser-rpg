# Tavernvale Browser RPG

A browser-based RPG prototype built as an experimental game project. The game includes progression systems, world events, combat-related gameplay, UI overlays, audio, and shop/economy features and lots more!!!

## Features

- Browser-based RPG gameplay
- UI overlays and interface systems
- Audio integration
- Shop and economy systems
- World event / boss event features
- Admin/testing pages
...
> **Note:** Most of the front-end for this project were AI-assisted. However, a large portion of the project was still completed and directed by me, including backend work, project structure, gameplay iteration, asset integration, music and SFX handling, 3D model work, visual editing, testing, and refinement. I used tools such as VS Code, Blender, Photoshop, and other supporting development and design software throughout the project.

## Project Structure

- `rpg.html` - main RPG/game page
- `player.html` - player-related interface
- `admin.html` - admin/testing functionality
